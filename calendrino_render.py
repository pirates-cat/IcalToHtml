			...
			for m, days in sorted(months.items()):
				...
				def callback(day):
					...
					for item in days[day][0]:
						...
						ret += "<div class='calitem timed %s'%s><div class='caltime'>%s</div><a href='%s'  target='_blank'>%s</a></div>" % (item['calsrcclass'], ttl, timestr,item['url'], item['summary'])
...
if __name__=='__main__':
	...
	#https://decidim.pirates.cat/calendar/ical
